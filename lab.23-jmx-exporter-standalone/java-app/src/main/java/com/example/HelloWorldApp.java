    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/", exchange -> {
            ...
            String response = String.format(
                ...
                "------------------------------\n" +
                "Request count : %d\n" +
                "JMX metrics   : http://localhost:9090/metrics\n" +
        ...
        server.start();
        System.out.println("==============================================");
        System.out.println("  Hello World App (remote JMX on port 9999)");
        System.out.println("==============================================");
        System.out.println("  App        -> http://localhost:8080");
        System.out.println("  JMX metrics -> http://localhost:9090/metrics");
